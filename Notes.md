...
Duplicate the Blue node to Black
Change Black nodes color to #000000
Move top black nodes up by exactly 90px
Move bottom black nodes down by exactly 90px
Move left & right black nodes out by exactly 90px 