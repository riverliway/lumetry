extends Level
## Room-specific logic for Level 10.
##
...
func _on_solved() -> void:
	...
	_play_dialogue("level_10_complete")
	_grant_achievement("clear_level_10")
	_save_progress()
...
func _play_dialogue(dialogue_id: String) -> void:
	print("[Level10] TODO play dialogue '%s' (dialogue engine not implemented)" % dialogue_id)


func _advance_to_next_room() -> void:
	print("[Level10] TODO advance to the next room (room transitions not implemented)")


func _save_progress() -> void:
	print("[Level10] TODO save progress (save system not implemented)")


func _grant_achievement(achievement_id: String) -> void:
	print("[Level10] TODO grant achievement '%s' (achievements not implemented)" % achievement_id)
