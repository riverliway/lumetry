extends Level
## Room-specific logic for Level 3.
##
...
func _on_solved() -> void:
	...
	_play_dialogue("level_3_complete")
	_grant_achievement("clear_level_3")
	_save_progress()
...
func _play_dialogue(dialogue_id: String) -> void:
	print("[Level3] TODO play dialogue '%s' (dialogue engine not implemented)" % dialogue_id)


func _advance_to_next_room() -> void:
	print("[Level3] TODO advance to the next room (room transitions not implemented)")


func _save_progress() -> void:
	print("[Level3] TODO save progress (save system not implemented)")


func _grant_achievement(achievement_id: String) -> void:
	print("[Level3] TODO grant achievement '%s' (achievements not implemented)" % achievement_id)
